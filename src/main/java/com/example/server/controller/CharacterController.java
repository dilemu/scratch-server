...
public class CharacterController {
    ...
    private JsonResult identifyNormalCharacter(@RequestParam("file") MultipartFile file, UniversalRequest universalRequest) throws Exception {
    ...
    private JsonResult identifyLicensePlate(@RequestParam("file") MultipartFile file, UniversalRequest universalRequest) throws Exception {
        if (StringUtils.isBlank(file.getOriginalFilename())) {
            throw new BizBaseException("文件不能为空");
        }
    ...
    private JsonResult identifyQRCode(@RequestParam("file") MultipartFile file) throws Exception {
        if (StringUtils.isBlank(file.getOriginalFilename())) {
            throw new BizBaseException("文件不能为空");
        }
    ...
    private JsonResult identifyHandwritten(@RequestParam("file") MultipartFile file, UniversalRequest universalRequest) throws Exception {
        if (StringUtils.isBlank(file.getOriginalFilename())) {
            throw new BizBaseException("文件不能为空");
        }
